...
const CetakTiket3Screen = ({ navigation }: {navigation: any}) => {
  ...
  const printTextTest = async () => {
    ...
    await BluetoothEscposPrinter.printText("TWBT230923PEGH\n\r", {});
    await BluetoothEscposPrinter.setBold(0);
    await BluetoothEscposPrinter.printText("--------------------------------\n\r",{});
    await BluetoothEscposPrinter.printText("Kelas : REGULAR\n\r", {});
    await BluetoothEscposPrinter.printText("By: 0\n\r", {});
    await BluetoothEscposPrinter.printText("11:00\n\r", {});
    await BluetoothEscposPrinter.printText("DIKA\n\r", {});
    await BluetoothEscposPrinter.printText("KURSI\n\r", {});
    await BluetoothEscposPrinter.printText("8\n\r", {});
    await BluetoothEscposPrinter.printText("--------------------------------\n\r",{});
    await BluetoothEscposPrinter.printText("04-Feb-2024\n\r", {});
    await BluetoothEscposPrinter.printText("Pergi : 04-Feb-2024\n\r", {});
    await BluetoothEscposPrinter.printText("Pick Up:\n\r", {});
    await BluetoothEscposPrinter.printText("SUBANG\n\r", {});
    await BluetoothEscposPrinter.printText("Drop Off\n\r", {});
    await BluetoothEscposPrinter.printText("DAGO\n\r", {});
    await BluetoothEscposPrinter.printText("--------------------------------\n\r",{});
    await BluetoothEscposPrinter.setBold(1);
    await BluetoothEscposPrinter.printText("Tarif: Rp. 160.000\n\r", {});
    await BluetoothEscposPrinter.setBold(0);
    await BluetoothEscposPrinter.printText("--------------------------------\n\r",{});
    await BluetoothEscposPrinter.printText("Biaya Jemput : Rp.0\n\r", {});
    await BluetoothEscposPrinter.printText("Biaya Antar : Rp.0\n\r", {});
    await BluetoothEscposPrinter.printText("Diskon : \n\r", {});
    await BluetoothEscposPrinter.printText("Return\n\r", {});
    await BluetoothEscposPrinter.printText("Rp. 30.000\n\r", {});
    await BluetoothEscposPrinter.printText("Bayar Rp. 130.000\n\r\n\r", {});
    
    await BluetoothEscposPrinter.printText("04-Feb-2024 14:27:47\n\r", {});
    await BluetoothEscposPrinter.printText("Pencetak : RAHMAN\n\r\n\r", {});
    await BluetoothEscposPrinter.printText("-------------VOUCHER------------\n\r",{});
    await BluetoothEscposPrinter.printText("Nama : DIKA\n\r", {});
    await BluetoothEscposPrinter.printText("Dago (BANDUNG) - Subang(SUBANG)\n\r\n\r", {});
    await BluetoothEscposPrinter.printText("TIKET BALIK\n\r", {});
    await BluetoothEscposPrinter.printText("FREE\n\r\n\r", {});
    await BluetoothEscposPrinter.printText("WBT230923632Z\n\r\n\r", {});
    await BluetoothEscposPrinter.printText("Berlaku Hingga\n\r", {});
    await BluetoothEscposPrinter.printText("20-03-2024\n\r", {});
    await BluetoothEscposPrinter.printText("\n\r\n\r\n\r", {});
...
export default CetakTiket3Screen;
